...
function CartesianChartContent({ data, xKey, yKeys, padding, domainPadding, children, renderOutside = () => null, axisOptions, domain, chartPressState, chartPressConfig, gestureHandlerConfig, onChartBoundsChange, onScaleChange, gestureLongPressDelay = 100, xAxis, yAxis, frame, transformState, transformConfig, customGestures, actionsRef, viewport, ref, }) {
    ...
    const { yAxes, xScale, chartBounds, isNumericalData, xTicksNormalized, _tData, } = React.useMemo(() => {
        ...
        const _l = (0, transformInputData_1.transformInputData)({
            ...
            axisScales: axisOptions === null || axisOptions === void 0 ? void 0 : axisOptions.axisScales,
    ...
    const panGesture = react_native_gesture_handler_1.Gesture.Pan()
        ...
        for (let i = 0; i < Math.min(e.allTouches.length, vals.length); i++) {
            ...
            if (gestureState.value.isGestureActive) {
                ...
                const scrolledX = ((_a = transformState === null || transformState === void 0 ? void 0 : transformState.matrix.value) === null || _a === void 0 ? void 0 : _a[3]) || 0;
                const scrolledY = ((_b = transformState === null || transformState === void 0 ? void 0 : transformState.matrix.value) === null || _b === void 0 ? void 0 : _b[7]) || 0;
                handleTouch(v, touch.absoluteX - scrolledX, touch.absoluteY - scrolledY);
            }
            else {
    ...
    const YAxisComponents = hasMeasuredLayoutSize && (axisOptions || yAxes)
        ? (_g = normalizedAxisProps.yAxes) === null || _g === void 0 ? void 0 : _g.map((axis, index) => {
            ...
            const tickN = (_a = axis.tickCount) !== null && _a !== void 0 ? _a : tickHelpers_1.DEFAULT_TICK_COUNT;
            const rescaledTicks = axis.enableRescaling
                ? (0, tickHelpers_1.exactTicksFromScale)(rescaled, tickN)
                : axis.tickValues
                    ? (0, tickHelpers_1.downsampleTicks)(axis.tickValues, tickN)
                    : (0, tickHelpers_1.exactTicksFromScale)(yAxis.yScale, tickN);
            const primaryTickN = (_b = primaryAxisProps.tickCount) !== null && _b !== void 0 ? _b : tickHelpers_1.DEFAULT_TICK_COUNT;
            const primaryTicksRescaled = primaryAxisProps.enableRescaling
                ? (0, tickHelpers_1.exactTicksFromScale)(primaryRescaled, primaryTickN)
                : primaryAxisProps.tickValues
                    ? (0, tickHelpers_1.downsampleTicks)(primaryAxisProps.tickValues, primaryTickN)
                    : (0, tickHelpers_1.exactTicksFromScale)(primaryYScale, primaryTickN);
    ...
    // Body of the chart.
    const body = (<react_native_skia_1.Canvas ref={canvasRef} style={{ flex: 1 }}>
      {YAxisComponents}
      {XAxisComponents}
      {FrameComponent}
    ...
    if (transformState) {
        ...
        if ((_l = (_k = transformConfig === null || transformConfig === void 0 ? void 0 : transformConfig.pan) === null || _k === void 0 ? void 0 : _k.enabled) !== null && _l !== void 0 ? _l : true) {
            gestures = react_native_gesture_handler_1.Gesture.Simultaneous(gestures, (0, transformGestures_1.panTransformGesture)(transformState, Object.assign(Object.assign({}, transformConfig === null || transformConfig === void 0 ? void 0 : transformConfig.pan), { canvasWidth: size.width, canvasHeight: size.height })));
        }
    ...
    return (<react_native_gesture_handler_1.GestureHandlerRootView>
      <react_native_1.View style={{ flex: 1, overflow: "hidden" }} onLayout={onLayout}>
        {body}
