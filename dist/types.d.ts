...
import { type Color, type DashPathEffect, type SkFont, type SkPoint } from "@shopify/react-native-skia";
import type { ZoomTransform } from "d3-zoom";
import { type PanGesture } from "react-native-gesture-handler";
import type { UserSelect, TouchAction } from "react-native-gesture-handler/lib/typescript/handlers/gestureHandlerCommon";
 ...
 */
export type SidedNumber = number | {
    left?: number;
    right?: number;
    top?: number;
    bottom?: number;
...
export type XAxisPropsWithDefaults<RawData extends Record<string, unknown>, XK extends keyof InputFields<RawData>> = Required<Omit<XAxisInputProps<RawData, XK>, "font" | "labelRenderer" | "tickValues" | "linePathEffect" | "enableRescaling" | "labelRotate">> & Partial<Pick<XAxisInputProps<RawData, XK>, "font" | "labelRenderer" | "tickValues" | "linePathEffect" | "enableRescaling" | "labelRotate">>;
...
export type YAxisPropsWithDefaults<RawData extends Record<string, unknown>, YK extends keyof NumericalFields<RawData>> = Required<Omit<YAxisInputProps<RawData, YK>, "font" | "labelRenderer" | "tickValues" | "linePathEffect" | "enableRescaling">> & Partial<Pick<YAxisInputProps<RawData, YK>, "font" | "labelRenderer" | "tickValues" | "linePathEffect" | "enableRescaling">>;
export type YAxisProps<RawData extends Record<string, unknown>, YK extends keyof NumericalFields<RawData>> = YAxisPropsWithDefaults<RawData, YK> & {
    xScale: Scale;
    yScale: Scale;
    yTicksNormalized: number[];
    yKeys: YK[];
...
export type FramePropsWithDefaults = Required<Omit<FrameInputProps, "linePathEffect">> & {
    linePathEffect?: DashPathEffectComponent;
};
...
type ExtractParams<T extends (...args: any[]) => any, // eslint-disable-line
P extends Parameters<T> = Parameters<T>> = P["length"] extends 1 ? P[0] : P;
